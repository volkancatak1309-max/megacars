...
export default function About() {
  ...
  return (
    <article ref={root} className="bg-bg">
      <section className="mx-auto max-w-[1000px] px-6 pb-20 pt-28 md:px-10 md:pt-36">
        <p className="reveal eyebrow text-muted">{t('about.eyebrow')}</p>
        <h1
          data-split
        ...
        <p className="reveal mt-8 max-w-[60ch] text-lg leading-relaxed text-muted">
          {t('about.intro')}
        </p>
      </section>
      ...
      <section className="mx-auto max-w-[1000px] px-6 py-24 md:px-10">
        <p className="reveal eyebrow text-muted">{t('about.valuesEyebrow')}</p>
        <div className="mt-10 grid gap-12 md:grid-cols-3">
          {values.map((v) => (
            <div key={v} className="reveal">
      ...
      <section className="mx-auto max-w-[1000px] px-6 pb-28 md:px-10">
        <div className="border-t border-border pt-12">
          <p className="reveal eyebrow text-muted">{t('about.locationEyebrow')}</p>
          <p className="reveal mt-4 text-xl font-medium text-text md:text-2xl">{CONTACT.addressFull}</p>
          <a
            href="#/kontakt"
            onClick={(e) => {
              e.preventDefault()
            ...
            className="reveal btn-fill mt-8 inline-block rounded-[2px] bg-accent px-7 py-3.5 text-sm font-medium text-white"
          >
            {t('about.cta')}
          </a>
        </div>

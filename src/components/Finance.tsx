  ...
  return (
    <article ref={root} className="bg-bg">
      <section className="mx-auto max-w-[1000px] px-6 pb-16 pt-28 md:px-10 md:pt-36">
        <p className="reveal eyebrow text-muted">{t('finance.eyebrow')}</p>
        <h1
          data-split
      ...
      <section className="mx-auto max-w-[1000px] px-6 pb-20 md:px-10">
        <p className="reveal eyebrow text-muted">{t('finance.howEyebrow')}</p>
      ...
      <section className="mx-auto max-w-[1000px] px-6 pb-28 md:px-10">
        <div className="border-t border-border pt-12">
          <p className="reveal max-w-[48ch] text-sm leading-relaxed text-muted">{t('finance.note')}</p>
          <a
            href={wa}
            target="_blank"
            rel="noopener noreferrer"
            className="reveal btn-fill mt-7 inline-block rounded-[2px] bg-accent px-7 py-3.5 text-sm font-medium text-white"
          >
            {t('finance.cta')}
          </a>
        </div>
